...
export class CatalogPage extends BasePage {
    ...
    async checkBreadcrumbsChipIsActive(chipName: string): Promise<boolean> {
        ...
        return className.includes('outlinedPrimary');
    }
